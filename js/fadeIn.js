$(document).ready(function() {
  ...
  if ($(window).scrollTop() > $("#fadeInProject").offset().top - 200) {
      $("#fadeInProject").animate({"opacity" : "1"}, 1200);
  ...
  if ($(window).scrollTop() > $("#fadeInPdf").offset().top - 400) {
      $("#fadeInPdf").animate({"opacity" : "1"}, 1000);
